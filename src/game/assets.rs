...
pub struct Assets {
    ...
    pub snack_image1: graphics::Image,
    pub snack_image2: graphics::Image,
    pub snack_image3: graphics::Image,
...
impl Assets {
    pub fn new(ctx: &mut Context) -> GameResult<Assets> {
        ...
        let snack_image1 =  graphics::Image::new(ctx, "/snack1.png")?;
        let snack_image2 =  graphics::Image::new(ctx, "/snack2.png")?;
        let snack_image3 =  graphics::Image::new(ctx, "/snack3.png")?;
